            ...
            <div className="container mx-auto px-4 md:px-6 mb-12">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-wrap items-center gap-6 text-sm text-slate-500 border-y border-slate-100 dark:border-slate-800 py-6">
                        ...
                        >
                            {copied ? (
                                <><CheckCircle className="w-4 h-4 text-green-500" /> <span className="text-green-500 text-xs">Link copiado!</span></>
                            ) : (
                    ...
                    {post.author && (
                        <div className="p-6 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 mb-16">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Escrito por</div>
                                                ...
                                                >
                                                    ...
                                                    {related.publishedAt && (
                                                        <span className="text-muted-foreground text-sm ml-2">
                                                            ({new Date(related.publishedAt).toLocaleDateString("pt-BR")})
                                                        </span>
                                                    )}
                                                </Link>
                                            </li>
