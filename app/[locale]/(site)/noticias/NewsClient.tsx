...
// Filters run statically on client
...
export default function NewsClient({ news }: { news: NewsPost[] }) {
    ...
    const tabs = [
        { id: 'noticias', label: t('tabs.noticias.label'), filter: (n: NewsPost) => !n.type || n.type === 'internal' },
        { id: 'midia', label: t('tabs.midia.label'), filter: (n: NewsPost) => n.type === 'external' },
    ];
                ...
                <div className="mb-12">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black tracking-tighter text-foreground mb-4">
                            {activeTab === 'noticias' ? t('tabs.noticias.title') : t('tabs.midia.title')}
                        </h1>
                        <p className="text-base md:text-lg text-muted-foreground max-w-2xl">
                            {activeTab === 'noticias' ? t('tabs.noticias.description') : t('tabs.midia.description')}
                        </p>
                    </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 p-6 md:p-8 flex flex-col">
                                            ...
                                            <div className="text-primary font-bold text-sm flex items-center gap-2 border-t border-slate-100 dark:border-slate-800 pt-4 mt-auto">
                                                {item.type === 'external' ? (
                                                    <>
                                                        {t('readExternal')} <ExternalLink className="w-4 h-4" />
                                                    </>
                                                ) : (
                                                    <>
