        ...
        <main className="min-h-screen bg-white dark:bg-slate-950 pt-24 pb-16">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 pb-16 pt-12">
                <div className="container mx-auto px-4 md:px-6">
                    <BackLink href="/projetos" label={tNav('backToProjects')} />
            ...
            <div className="container mx-auto px-4 md:px-6 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    ...
                    <div className="lg:col-span-2">
                        <h2 className="text-2xl font-bold text-foreground mb-6">{t('about')}</h2>
                        ...
                        {project.features && project.features.length > 0 && (
                            <div className="mt-12">
                                <h3 className="text-xl font-bold text-foreground mb-6">{t('features')}</h3>
                    ...
                    <div className="space-y-8">
                        ...
                        {project.researchAreas && project.researchAreas.length > 0 && (
                            <div className="p-6 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
                                <h3 className="flex items-center gap-2 font-bold text-foreground mb-4">
                                    <LucideIcons.Microscope className="w-5 h-5 text-primary" /> {t('researchLines')}
                                </h3>
                        ...
                        {project.partners && project.partners.length > 0 && (
                            <div className="p-6 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
                                <h3 className="flex items-center gap-2 font-bold text-foreground mb-4">
                                    <Users className="w-5 h-5 text-primary" /> {t('partners')}
                                </h3>
                        ...
                        {project.relatedProjects && project.relatedProjects.length > 0 && (
                            <div className="p-6 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
                                <h3 className="flex items-center gap-2 font-bold text-foreground mb-4">
                                    <LucideIcons.Layers className="w-5 h-5 text-primary" /> {t('relatedProjects')}
                                </h3>
                        ...
                        {relatedPublications.length > 0 && (
                            <div className="p-6 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
                                <h3 className="flex items-center gap-2 font-bold text-foreground mb-4">
                                    <LucideIcons.BookOpen className="w-5 h-5 text-primary" /> {t('publications')}
                                </h3>
